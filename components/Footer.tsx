      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="reveal opacity-0 delay-200 py-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            <a href="/privacy-policy" className="text-sm text-slate-500 hover:text-white transition-colors duration-300">
              Privacy Policy
            </a>
            <a href="/terms-of-service" className="text-sm text-slate-500 hover:text-white transition-colors duration-300">
              Terms of Service
            </a>
          </div>
        </div>
