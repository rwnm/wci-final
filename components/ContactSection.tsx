...
export default function ContactSection() {
  ...
  return (
    <section ref={sectionRef} id="contact" className="py-24 bg-slate-50 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="reveal opacity-0">
            <span className="block text-sm font-mono font-semibold text-sky-600 tracking-wider uppercase mb-4">
              Get in Touch
            </span>
